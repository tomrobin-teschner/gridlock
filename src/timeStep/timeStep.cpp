...
TimeStep::TimeStepType TimeStep::getTimeStep(FieldArray &u, FieldArray &v, double dx, double dy,
  double resU, double resV, double resP) {
  double CFL = _CFL;
  if (_useSER) {
    // Switched evolution relaxation (SER) impplemented as in: 
